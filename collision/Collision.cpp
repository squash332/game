...
bool collision::isInMeleeRange(const Entity &entity1, const Entity &entity2)
{
    ...
    MeleeRangeCircle e1 = entity1.getMeleeHitbox();
    MeleeRangeCircle e2 = entity2.getMeleeHitbox();

    return CheckCollisionCircles(e1.center, e1.radius, e2.center, e2.radius);
}
